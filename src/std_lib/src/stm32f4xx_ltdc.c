...
void LTDC_Init(LTDC_InitTypeDef* LTDC_InitStruct)
{
  ...
  assert(IS_LTDC_HSYNC(LTDC_InitStruct->LTDC_HorizontalSync));
  assert(IS_LTDC_VSYNC(LTDC_InitStruct->LTDC_VerticalSync));
  assert(IS_LTDC_AHBP(LTDC_InitStruct->LTDC_AccumulatedHBP));
  assert(IS_LTDC_AVBP(LTDC_InitStruct->LTDC_AccumulatedVBP));
  assert(IS_LTDC_AAH(LTDC_InitStruct->LTDC_AccumulatedActiveH));
  assert(IS_LTDC_AAW(LTDC_InitStruct->LTDC_AccumulatedActiveW));
  assert(IS_LTDC_TOTALH(LTDC_InitStruct->LTDC_TotalHeigh));
  assert(IS_LTDC_TOTALW(LTDC_InitStruct->LTDC_TotalWidth));
  assert(IS_LTDC_HSPOL(LTDC_InitStruct->LTDC_HSPolarity));
  assert(IS_LTDC_VSPOL(LTDC_InitStruct->LTDC_VSPolarity));
  assert(IS_LTDC_DEPOL(LTDC_InitStruct->LTDC_DEPolarity));
  assert(IS_LTDC_PCPOL(LTDC_InitStruct->LTDC_PCPolarity));
  assert(IS_LTDC_BackBlueValue(LTDC_InitStruct->LTDC_BackgroundBlueValue));
  assert(IS_LTDC_BackGreenValue(LTDC_InitStruct->LTDC_BackgroundGreenValue));
  assert(IS_LTDC_BackRedValue(LTDC_InitStruct->LTDC_BackgroundRedValue));
...
{
  /* Check the parameters */
  assert(IS_LTDC_LIPOS(LTDC_LIPositionConfig));
...
{
  /* Check the parameters */
  assert(IS_LTDC_RELOAD(LTDC_Reload));
...
/* Check the parameters */
  assert(IS_LTDC_Pixelformat(LTDC_Layer_InitStruct->LTDC_PixelFormat));
  assert(IS_LTDC_BlendingFactor1(LTDC_Layer_InitStruct->LTDC_BlendingFactor_1));
  assert(IS_LTDC_BlendingFactor2(LTDC_Layer_InitStruct->LTDC_BlendingFactor_2));
  assert(IS_LTDC_HCONFIGST(LTDC_Layer_InitStruct->LTDC_HorizontalStart));
  assert(IS_LTDC_HCONFIGSP(LTDC_Layer_InitStruct->LTDC_HorizontalStop));
  assert(IS_LTDC_VCONFIGST(LTDC_Layer_InitStruct->LTDC_VerticalStart));
  assert(IS_LTDC_VCONFIGSP(LTDC_Layer_InitStruct->LTDC_VerticalStop));
  assert(IS_LTDC_DEFAULTCOLOR(LTDC_Layer_InitStruct->LTDC_DefaultColorBlue));
  assert(IS_LTDC_DEFAULTCOLOR(LTDC_Layer_InitStruct->LTDC_DefaultColorGreen));
  assert(IS_LTDC_DEFAULTCOLOR(LTDC_Layer_InitStruct->LTDC_DefaultColorRed));
  assert(IS_LTDC_DEFAULTCOLOR(LTDC_Layer_InitStruct->LTDC_DefaultColorAlpha));
  assert(IS_LTDC_CFBP(LTDC_Layer_InitStruct->LTDC_CFBPitch));
  assert(IS_LTDC_CFBLL(LTDC_Layer_InitStruct->LTDC_CFBLineLength));
  assert(IS_LTDC_CFBLNBR(LTDC_Layer_InitStruct->LTDC_CFBLineNumber));
...
void LTDC_ColorKeyingConfig(LTDC_Layer_TypeDef* LTDC_Layerx, LTDC_ColorKeying_InitTypeDef* LTDC_colorkeying_InitStruct, FunctionalState NewState)
{
  ...
  /* Check the parameters */
  assert(IS_FUNCTIONAL_STATE(NewState));
  assert(IS_LTDC_CKEYING(LTDC_colorkeying_InitStruct->LTDC_ColorKeyBlue));
  assert(IS_LTDC_CKEYING(LTDC_colorkeying_InitStruct->LTDC_ColorKeyGreen));
  assert(IS_LTDC_CKEYING(LTDC_colorkeying_InitStruct->LTDC_ColorKeyRed));
...
void LTDC_CLUTInit(LTDC_Layer_TypeDef* LTDC_Layerx, LTDC_CLUT_InitTypeDef* LTDC_CLUT_InitStruct)
{
  ...
  /* Check the parameters */
  assert(IS_LTDC_CLUTWR(LTDC_CLUT_InitStruct->LTDC_CLUTAdress));
  assert(IS_LTDC_CLUTWR(LTDC_CLUT_InitStruct->LTDC_RedValue));
  assert(IS_LTDC_CLUTWR(LTDC_CLUT_InitStruct->LTDC_GreenValue));
  assert(IS_LTDC_CLUTWR(LTDC_CLUT_InitStruct->LTDC_BlueValue));
