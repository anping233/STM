...
void DFSDM_TransceiverInit(DFSDM_Channel_TypeDef* DFSDM_Channelx, DFSDM_TransceiverInitTypeDef* DFSDM_TransceiverInitStruct)
{
    ...
    assert(IS_DFSDM_ALL_CHANNEL(DFSDM_Channelx));
    assert(IS_DFSDM_INTERFACE(DFSDM_TransceiverInitStruct->DFSDM_Interface));
    assert(IS_DFSDM_Input_MODE(DFSDM_TransceiverInitStruct->DFSDM_Input));
    assert(IS_DFSDM_Redirection_STATE(DFSDM_TransceiverInitStruct->DFSDM_Redirection));
    assert(IS_DFSDM_PACK_MODE(DFSDM_TransceiverInitStruct->DFSDM_PackingMode));
    assert(IS_DFSDM_CLOCK(DFSDM_TransceiverInitStruct->DFSDM_Clock));
    assert(IS_DFSDM_DATA_RIGHT_BIT_SHIFT(DFSDM_TransceiverInitStruct->DFSDM_DataRightShift));
    assert(IS_DFSDM_OFFSET(DFSDM_TransceiverInitStruct->DFSDM_Offset));
    assert(IS_DFSDM_CLK_DETECTOR_STATE(DFSDM_TransceiverInitStruct->DFSDM_CLKAbsenceDetector));
    assert(IS_DFSDM_SC_DETECTOR_STATE(DFSDM_TransceiverInitStruct->DFSDM_ShortCircuitDetector));
...
void DFSDM_FilterInit(DFSDM_Filter_TypeDef* DFSDMx, DFSDM_FilterInitTypeDef* DFSDM_FilterInitStruct)
{
    ...
    /* Check the parameters */
    assert(IS_DFSDM_ALL_FILTER(DFSDMx));
    assert(IS_DFSDM_SINC_ORDER(DFSDM_FilterInitStruct->DFSDM_SincOrder));
    assert(IS_DFSDM_SINC_OVRSMPL_RATIO(DFSDM_FilterInitStruct->DFSDM_FilterOversamplingRatio));
    assert(IS_DFSDM_INTG_OVRSMPL_RATIO(DFSDM_FilterInitStruct->DFSDM_IntegratorOversamplingRatio));
...
void DFSDM_ConfigClkOutputDivider(uint32_t DFSDM_ClkOutDivision)
{
    ...
    /* Check the parameters */
    assert(IS_DFSDM_CLOCK_OUT_DIVIDER(DFSDM_ClkOutDivision));
...
void DFSDM_ConfigClkOutputSource(uint32_t DFSDM_ClkOutSource)
{
  ...
  /* Check the parameters */
  assert(IS_DFSDM_CLOCK_OUT_SOURCE(DFSDM_ClkOutSource));
...
void DFSDM_ConfigBRKAnalogWatchDog(DFSDM_Channel_TypeDef* DFSDM_Channelx, uint32_t DFSDM_SCDBreak_i, FunctionalState NewState)
{
  /* Check the parameters */
  assert(IS_DFSDM_ALL_CHANNEL(DFSDM_Channelx));
  assert(IS_DFSDM_SCD_BREAK_SIGNAL(DFSDM_SCDBreak_i));
  assert(IS_FUNCTIONAL_STATE(NewState));
...
void DFSDM_ConfigShortCircuitThreshold(DFSDM_Channel_TypeDef* DFSDM_Channelx, uint32_t DFSDM_SCDThreshold)
{
    ...
    /* Check the parameters */
    assert(IS_DFSDM_ALL_CHANNEL(DFSDM_Channelx));
    assert(IS_DFSDM_CSD_THRESHOLD_VALUE(DFSDM_SCDThreshold));
...
void DFSDM_ConfigAnalogWatchdog(DFSDM_Filter_TypeDef* DFSDMx, uint32_t DFSDM_AWDChannelx, uint32_t DFSDM_AWDFastMode)
{
  ...
  /* Check the parameters */
  assert(IS_DFSDM_ALL_FILTER(DFSDMx));
  assert(IS_DFSDM_AWD_CHANNEL(DFSDM_AWDChannelx));
  assert(IS_DFSDM_AWD_MODE(DFSDM_AWDFastMode));
...
void DFSDM_SelectExtremesDetectorChannel(DFSDM_Filter_TypeDef* DFSDMx, uint32_t DFSDM_ExtremChannelx)
{
  ...
  /* Check the parameters */
  assert(IS_DFSDM_ALL_FILTER(DFSDMx));
  assert(IS_DFSDM_EXTREM_CHANNEL(DFSDM_ExtremChannelx));
...
void DFSDM_ConfigAWDFilter(DFSDM_Channel_TypeDef* DFSDM_Channelx, uint32_t DFSDM_AWDSincOrder, uint32_t DFSDM_AWDSincOverSampleRatio)
{
    ...
    /* Check the parameters */
    assert(IS_DFSDM_ALL_CHANNEL(DFSDM_Channelx));
    assert(IS_DFSDM_AWD_SINC_ORDER(DFSDM_AWDSincOrder));
    assert(IS_DFSDM_AWD_OVRSMPL_RATIO(DFSDM_AWDSincOverSampleRatio));
...
void DFSDM_SetAWDThreshold(DFSDM_Filter_TypeDef* DFSDMx, uint32_t DFSDM_HighThreshold, uint32_t DFSDM_LowThreshold)
{
    ...
    /* Check the parameters */
    assert(IS_DFSDM_HIGH_THRESHOLD(DFSDM_HighThreshold));
    assert(IS_DFSDM_LOW_THRESHOLD(DFSDM_LowThreshold));
...
void DFSDM_SelectInjectedChannel(DFSDM_Filter_TypeDef* DFSDMx, uint32_t DFSDM_InjectedChannelx)
{
  ...
  /* Check the parameters */
  assert(IS_DFSDM_ALL_FILTER(DFSDMx));
  assert(IS_DFSDM_INJECT_CHANNEL(DFSDM_InjectedChannelx));
...
void DFSDM_SelectRegularChannel(DFSDM_Filter_TypeDef* DFSDMx, uint32_t DFSDM_RegularChannelx)
{
  ...
  /* Check the parameters */
  assert(IS_DFSDM_ALL_FILTER(DFSDMx));
  assert(IS_DFSDM_REGULAR_CHANNEL(DFSDM_RegularChannelx));
...
void DFSDM_ConfigInjectedTrigger(DFSDM_Filter_TypeDef* DFSDMx, uint32_t DFSDM_Trigger, uint32_t DFSDM_TriggerEdge)
{
  ...
  if (DFSDMx == DFSDM0)
  {
    assert(IS_DFSDM0_INJ_TRIGGER(DFSDM_Trigger));
  }
  else
  {
    assert(IS_DFSDM1_INJ_TRIGGER(DFSDM_Trigger));
  }

  assert(IS_DFSDM_TRIGGER_EDGE(DFSDM_TriggerEdge));
...
{
  /* Check the parameters */
  assert(IS_DFSDM_SYNC_FILTER(DFSDMx));
...
void DFSDM_SelectInjectedConversionMode(DFSDM_Filter_TypeDef* DFSDMx, uint32_t DFSDM_InjectConvMode)
{
  /* Check the parameters */
  assert(IS_DFSDM_ALL_FILTER(DFSDMx));
  assert(IS_DFSDM_INJ_CONV_MODE(DFSDM_InjectConvMode));
...
void DFSDM_DMATransferConfig(DFSDM_Filter_TypeDef* DFSDMx, uint32_t DFSDM_DMAConversionMode, FunctionalState NewState)
{
  /* Check the parameters */
  assert(IS_DFSDM_ALL_FILTER(DFSDMx));
  assert(IS_DFSDM_CONVERSION_MODE(DFSDM_DMAConversionMode));
  assert(IS_FUNCTIONAL_STATE(NewState));
...
FlagStatus DFSDM_GetFlagStatus(DFSDM_Filter_TypeDef* DFSDMx, uint32_t DFSDM_FLAG)
{
  ...
  /* Check the parameters */
  assert(IS_DFSDM_ALL_FILTER(DFSDMx));
  assert(IS_DFSDM_FLAG(DFSDM_FLAG));
...
FlagStatus DFSDM_GetClockAbsenceFlagStatus(uint32_t DFSDM_FLAG_CLKAbsence)
{
  ...
  /* Check the parameters */
  assert(IS_DFSDM_CLK_ABS_FLAG(DFSDM_FLAG_CLKAbsence));
...
FlagStatus DFSDM_GetShortCircuitFlagStatus(uint32_t DFSDM_FLAG_SCD)
{
  ...
  /* Check the parameters */
  assert(IS_DFSDM_SCD_FLAG(DFSDM_FLAG_SCD));
...
FlagStatus DFSDM_GetWatchdogFlagStatus(DFSDM_Filter_TypeDef* DFSDMx, uint32_t DFSDM_AWDChannelx, uint8_t DFSDM_Threshold)
{
  ...
  /* Check the parameters */
  assert(IS_DFSDM_ALL_FILTER(DFSDMx));
  assert(IS_DFSDM_Threshold(DFSDM_Threshold));
  assert(IS_DFSDM_AWD_CHANNEL(DFSDM_AWDChannelx));
...
void DFSDM_ClearFlag(DFSDM_Filter_TypeDef* DFSDMx, uint32_t DFSDM_CLEARF)
{
  /* Check the parameters */
  assert(IS_DFSDM_ALL_FILTER(DFSDMx));
  assert(IS_DFSDM_CLEAR_FLAG(DFSDM_CLEARF));
...
{
  /* Check the parameters */
  assert(IS_DFSDM_CLK_ABS_CLEARF(DFSDM_CLEARF_CLKAbsence));
...
{
  /* Check the parameters */
  assert(IS_DFSDM_SCD_CHANNEL_FLAG(DFSDM_CLEARF_SCD));
...
ITStatus DFSDM_GetClockAbsenceITStatus(uint32_t DFSDM_IT_CLKAbsence)
{
  ...
  /* Check the parameters */
  assert(IS_DFSDM_CLK_ABS_IT(DFSDM_IT_CLKAbsence));
...
ITStatus DFSDM_GetShortCircuitITStatus(uint32_t DFSDM_IT_SCR)
{
  ...
  /* Check the parameters */
  assert(IS_DFSDM_SCD_IT(DFSDM_IT_SCR));
