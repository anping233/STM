...
void DMA2D_Init(DMA2D_InitTypeDef* DMA2D_InitStruct)
{
  ...
  assert(IS_DMA2D_MODE(DMA2D_InitStruct->DMA2D_Mode));
  assert(IS_DMA2D_CMODE(DMA2D_InitStruct->DMA2D_CMode));
  assert(IS_DMA2D_OGREEN(DMA2D_InitStruct->DMA2D_OutputGreen));
  assert(IS_DMA2D_ORED(DMA2D_InitStruct->DMA2D_OutputRed));
  assert(IS_DMA2D_OBLUE(DMA2D_InitStruct->DMA2D_OutputBlue));
  assert(IS_DMA2D_OALPHA(DMA2D_InitStruct->DMA2D_OutputAlpha));
  assert(IS_DMA2D_OUTPUT_OFFSET(DMA2D_InitStruct->DMA2D_OutputOffset));
  assert(IS_DMA2D_LINE(DMA2D_InitStruct->DMA2D_NumberOfLine));
  assert(IS_DMA2D_PIXEL(DMA2D_InitStruct->DMA2D_PixelPerLine));
...
void DMA2D_FGConfig(DMA2D_FG_InitTypeDef* DMA2D_FG_InitStruct)
{
  ...
  assert(IS_DMA2D_FGO(DMA2D_FG_InitStruct->DMA2D_FGO));
  assert(IS_DMA2D_FGCM(DMA2D_FG_InitStruct->DMA2D_FGCM));
  assert(IS_DMA2D_FG_CLUT_CM(DMA2D_FG_InitStruct->DMA2D_FG_CLUT_CM));
  assert(IS_DMA2D_FG_CLUT_SIZE(DMA2D_FG_InitStruct->DMA2D_FG_CLUT_SIZE));
  assert(IS_DMA2D_FG_ALPHA_MODE(DMA2D_FG_InitStruct->DMA2D_FGPFC_ALPHA_MODE));
  assert(IS_DMA2D_FG_ALPHA_VALUE(DMA2D_FG_InitStruct->DMA2D_FGPFC_ALPHA_VALUE));
  assert(IS_DMA2D_FGC_BLUE(DMA2D_FG_InitStruct->DMA2D_FGC_BLUE));
  assert(IS_DMA2D_FGC_GREEN(DMA2D_FG_InitStruct->DMA2D_FGC_GREEN));
  assert(IS_DMA2D_FGC_RED(DMA2D_FG_InitStruct->DMA2D_FGC_RED));
...
void DMA2D_BGConfig(DMA2D_BG_InitTypeDef* DMA2D_BG_InitStruct)
{
  ...
  assert(IS_DMA2D_BGO(DMA2D_BG_InitStruct->DMA2D_BGO));
  assert(IS_DMA2D_BGCM(DMA2D_BG_InitStruct->DMA2D_BGCM));
  assert(IS_DMA2D_BG_CLUT_CM(DMA2D_BG_InitStruct->DMA2D_BG_CLUT_CM));
  assert(IS_DMA2D_BG_CLUT_SIZE(DMA2D_BG_InitStruct->DMA2D_BG_CLUT_SIZE));
  assert(IS_DMA2D_BG_ALPHA_MODE(DMA2D_BG_InitStruct->DMA2D_BGPFC_ALPHA_MODE));
  assert(IS_DMA2D_BG_ALPHA_VALUE(DMA2D_BG_InitStruct->DMA2D_BGPFC_ALPHA_VALUE));
  assert(IS_DMA2D_BGC_BLUE(DMA2D_BG_InitStruct->DMA2D_BGC_BLUE));
  assert(IS_DMA2D_BGC_GREEN(DMA2D_BG_InitStruct->DMA2D_BGC_GREEN));
  assert(IS_DMA2D_BGC_RED(DMA2D_BG_InitStruct->DMA2D_BGC_RED));
...
void DMA2D_DeadTimeConfig(uint32_t DMA2D_DeadTime, FunctionalState NewState)
{
  ...
  /* Check the parameters */
  assert(IS_DMA2D_DEAD_TIME(DMA2D_DeadTime));
  assert(IS_FUNCTIONAL_STATE(NewState));
...
{
  /* Check the parameters */
  assert(IS_DMA2D_LineWatermark(DMA2D_LWatermarkConfig));
...
FlagStatus DMA2D_GetFlagStatus(uint32_t DMA2D_FLAG)
{
  ...
  /* Check the parameters */
  assert(IS_DMA2D_GET_FLAG(DMA2D_FLAG));
