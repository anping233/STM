...
void RTC_AlarmSubSecondConfig(uint32_t RTC_Alarm, uint32_t RTC_AlarmSubSecondValue, uint32_t RTC_AlarmSubSecondMask)
{
  ...
  /* Check the parameters */
  assert(IS_RTC_ALARM(RTC_Alarm));
  assert(IS_RTC_ALARM_SUB_SECOND_VALUE(RTC_AlarmSubSecondValue));
  assert(IS_RTC_ALARM_SUB_SECOND_MASK(RTC_AlarmSubSecondMask));
...
{
  /* Check the parameters */
  assert(IS_RTC_CALIB_OUTPUT(RTC_CalibOutput));
                                  ...
                                  uint32_t RTC_SmouthCalibMinusPulsesValue)
{
  ...
  /* Check the parameters */
  assert(IS_RTC_SMOOTH_CALIB_PERIOD(RTC_SmoothCalibPeriod));
  assert(IS_RTC_SMOOTH_CALIB_PLUS(RTC_SmoothCalibPlusPulses));
  assert(IS_RTC_SMOOTH_CALIB_MINUS(RTC_SmouthCalibMinusPulsesValue));
...
{
  /* Check the parameters */
  assert(IS_RTC_TAMPER_FILTER(RTC_TamperFilter));
...
{
  /* Check the parameters */
  assert(IS_RTC_TAMPER_SAMPLING_FREQ(RTC_TamperSamplingFreq));
...
{
  /* Check the parameters */
  assert(IS_RTC_TAMPER_PRECHARGE_DURATION(RTC_TamperPrechargeDuration));
...
ErrorStatus RTC_SynchroShiftConfig(uint32_t RTC_ShiftAdd1S, uint32_t RTC_ShiftSubFS)
{
  ...
  /* Check the parameters */
  assert(IS_RTC_SHIFT_ADD1S(RTC_ShiftAdd1S));
  assert(IS_RTC_SHIFT_SUBFS(RTC_ShiftSubFS));
