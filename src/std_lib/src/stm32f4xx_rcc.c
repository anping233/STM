...
void RCC_PLLI2SConfig(uint32_t PLLI2SN, uint32_t PLLI2SR, uint32_t PLLI2SM)
{
  /* Check the parameters */
  assert(IS_RCC_PLLI2SN_VALUE(PLLI2SN));
  assert(IS_RCC_PLLI2SM_VALUE(PLLI2SM));
  assert(IS_RCC_PLLI2SR_VALUE(PLLI2SR));
...
void RCC_PLLI2SConfig(uint32_t PLLI2SN, uint32_t PLLI2SQ, uint32_t PLLI2SR)
{
  /* Check the parameters */
  assert(IS_RCC_PLLI2SN_VALUE(PLLI2SN));
  assert(IS_RCC_PLLI2SQ_VALUE(PLLI2SQ));
  assert(IS_RCC_PLLI2SR_VALUE(PLLI2SR));
...
void RCC_PLLI2SConfig(uint32_t PLLI2SM, uint32_t PLLI2SN, uint32_t PLLI2SP, uint32_t PLLI2SQ, uint32_t PLLI2SR)
{
  ...
  assert(IS_RCC_PLLI2SM_VALUE(PLLI2SM));
  assert(IS_RCC_PLLI2SN_VALUE(PLLI2SN));
  assert(IS_RCC_PLLI2SP_VALUE(PLLI2SP));
  assert(IS_RCC_PLLI2SQ_VALUE(PLLI2SQ));
  assert(IS_RCC_PLLI2SR_VALUE(PLLI2SR));
...
{
  /* Check the parameters */
  assert(IS_RCC_PLLSAIN_VALUE(PLLSAIN));
  assert(IS_RCC_PLLSAIP_VALUE(PLLSAIP));
  assert(IS_RCC_PLLSAIQ_VALUE(PLLSAIQ));
  assert(IS_RCC_PLLSAIR_VALUE(PLLSAIR));
...
{
  /* Check the parameters */
  assert(IS_RCC_PLLSAIM_VALUE(PLLSAIM));
  assert(IS_RCC_PLLSAIN_VALUE(PLLSAIN));
  assert(IS_RCC_PLLSAIP_VALUE(PLLSAIP));
  assert(IS_RCC_PLLSAIQ_VALUE(PLLSAIQ));
...
void RCC_I2SCLKConfig(uint32_t RCC_I2SAPBx, uint32_t RCC_I2SCLKSource)
{
  ...
  assert(IS_RCC_I2S_APBx(RCC_I2SAPBx));
...
{
  /* Check the parameters */
  assert(IS_RCC_SAICLK_SOURCE(RCC_SAICLKSource));
  assert(IS_RCC_SAI_INSTANCE(RCC_SAIInstance));
...
void RCC_SAIBlockACLKConfig(uint32_t RCC_SAIBlockACLKSource)
{
  ...
  /* Check the parameters */
  assert(IS_RCC_SAIACLK_SOURCE(RCC_SAIBlockACLKSource));
...
void RCC_SAIBlockBCLKConfig(uint32_t RCC_SAIBlockBCLKSource)
{
  ...
  /* Check the parameters */
  assert(IS_RCC_SAIBCLK_SOURCE(RCC_SAIBlockBCLKSource));
...
void RCC_SAIPLLI2SClkDivConfig(uint32_t RCC_PLLI2SDivQ)
{
  ...
  /* Check the parameters */
  assert(IS_RCC_PLLI2S_DIVQ_VALUE(RCC_PLLI2SDivQ));
...
void RCC_SAIPLLSAIClkDivConfig(uint32_t RCC_PLLSAIDivQ)
{
  ...
  /* Check the parameters */
  assert(IS_RCC_PLLSAI_DIVQ_VALUE(RCC_PLLSAIDivQ));
...
void RCC_SAIPLLI2SRClkDivConfig(uint32_t RCC_PLLI2SDivR)
{
  ...
  /* Check the parameters */
  assert(IS_RCC_PLLI2S_DIVR_VALUE(RCC_PLLI2SDivR));
...
void RCC_SAIPLLRClkDivConfig(uint32_t RCC_PLLDivR)
{
  ...
  /* Check the parameters */
  assert(IS_RCC_PLL_DIVR_VALUE(RCC_PLLDivR));
...
void RCC_LTDCCLKDivConfig(uint32_t RCC_PLLSAIDivR)
{
  ...
  /* Check the parameters */
  assert(IS_RCC_PLLSAI_DIVR_VALUE(RCC_PLLSAIDivR));
...
void RCC_DFSDM1CLKConfig(uint32_t RCC_DFSDMCLKSource)
{
  ...
  /* Check the parameters */
  assert(IS_RCC_DFSDM1CLK_SOURCE(RCC_DFSDMCLKSource));
...
void RCC_DFSDM1ACLKConfig(uint32_t RCC_DFSDM1ACLKSource)
{
  ...
  /* Check the parameters */
  assert(IS_RCC_DFSDMACLK_SOURCE(RCC_DFSDM1ACLKSource));
...
void RCC_DFSDM2ACLKConfig(uint32_t RCC_DFSDMACLKSource)
{
  ...
  /* Check the parameters */
  assert(IS_RCC_DFSDMCLK_SOURCE(RCC_DFSDMACLKSource));
...
{
  /* Check the parameters */
  assert(IS_RCC_TIMCLK_PRESCALER(RCC_TIMCLKPrescaler));
...
{
  /* Check the parameters */
  assert(IS_RCC_LSE_MODE(RCC_Mode));
...
{
  /* Check the parameters */
  assert(IS_RCC_LPTIM1_CLOCKSOURCE(RCC_ClockSource));
...
{
  /* Check the parameters */
  assert(IS_RCC_DSI_CLOCKSOURCE(RCC_ClockSource));
...
{
  /* Check the parameters */
  assert(IS_RCC_48MHZ_CLOCKSOURCE(RCC_ClockSource));
#if defined(STM32F469_479xx)
...
{
  /* Check the parameters */
  assert(IS_RCC_SDIO_CLOCKSOURCE(RCC_ClockSource));
#if defined(STM32F469_479xx)
...
{
  /* Check the parameters */
  assert(IS_RCC_AHB1_CLOCKGATING(RCC_AHB1ClockGating));
...
{
  /* Check the parameters */
  assert(IS_RCC_SPDIFRX_CLOCKSOURCE(RCC_ClockSource));
...
{
  /* Check the parameters */
  assert(IS_RCC_CEC_CLOCKSOURCE(RCC_ClockSource));
...
{
  /* Check the parameters */
  assert(IS_RCC_FMPI2C1_CLOCKSOURCE(RCC_ClockSource));
